...
// The code from this file was taken from EF.Utility.CS.ttinclude
// This code was modified where appropriate to handle runtime T4.
namespace PhillipScottGivens.Library.PsgCore.Generators
{
    ...
    public class TemplateFileManager
    {
        ...
        /// </summary>
        public TemplateFileManager(StringBuilder generationEnvironment)
        {
        ...
        /// </summary>
        public virtual IEnumerable<string> Process(string outputPath, bool split = true)
        {
